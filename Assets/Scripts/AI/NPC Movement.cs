...
// Moves NPC objects along path waypoints.
// Requests paths from pathfinding manager.
// Notifies listeners when target is reached.
namespace PandaCafe.AI
{
    public class NPCMovement : MonoBehaviour
    {
         ...
         private void Update()
        {
            ...
            transform.position = Vector2.MoveTowards(transform.position, waypoint, speed * speedMultiplier * Time.deltaTime);
