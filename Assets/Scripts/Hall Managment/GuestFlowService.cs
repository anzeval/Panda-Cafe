...
// Handles guest movement requests.
// Moves guests from queue to selected tables.
// Registers seated guests for patience events.
namespace PandaCafe.HallManagment
{
    public class GuestFlowService 
    {
        private readonly QueueManager queueManager;
        private readonly SeatingService seatingService;
        private readonly GuestPatienceCoordinator guestPatienceCoordinator;

        // Create guest flow service
